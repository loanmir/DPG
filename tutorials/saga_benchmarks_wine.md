...
![RF confusion matrix](results/saga_benchmarks_wine/rf_confusion_matrix.png)
...
![Wine pairplot](results/saga_benchmarks_wine/pairplot.png)
...
![LRC vs RF importance](results/saga_benchmarks_wine/lrc_vs_rf_importance.png)
...
![Top LRC predicate splits](results/saga_benchmarks_wine/top_lrc_predicate_splits.png)
...
![BC bottleneck PCA cloud](results/saga_benchmarks_wine/bc_bottleneck_pca_cloud.png)
...
![DPG graph](results/saga_benchmarks_wine/wine_dpg.png)

Community-colored view:

![DPG communities](results/saga_benchmarks_wine/wine_dpg_communities.png)
...
![Community class-feature heatmap](results/saga_benchmarks_wine/communities_class_feature_complexity_heatmap.png)

Class predicate volume and feature coverage:

![Community class complexity bars](results/saga_benchmarks_wine/communities_class_feature_complexity_bars.png)
...
![DPG vs dataset feature ranges](results/saga_benchmarks_wine/dpg_vs_dataset_feature_ranges.png)
